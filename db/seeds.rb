...
# category
 ...
 Service.create(rate: 10,000, user: user1, category: category3, name: "Post Construction cleaning" , description: "Professional office floors cleaning")
 Service.create(rate: 20,000 , user: user1, category: category4, name: "Landscaping" , description: "Revive your surroundings with our professional landscaping services")
